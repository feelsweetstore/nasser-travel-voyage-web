...
const CTASection = () => {
  return (
    <section className="relative py-16 md:py-20" style={{ backgroundImage: `url("${'/lovable-uploads/8a84ada8-e405-4890-8c60-4e6be946ee49.png'}")`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      {/* Overlay */}
      ...
      <div className="container-custom relative z-10 text-white">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="https://wa.me/23566000000" className="btn-white bg-white text-blue-600 flex items-center hover:bg-blue-50">
