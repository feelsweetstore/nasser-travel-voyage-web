      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Obtenez un devis personnalisé pour votre voyage. Notre équipe vous proposera les meilleures options adaptées à vos besoins.
          </p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
            <TabsContent value="form">
              ...
              <p className="text-gray-600 mb-8 text-center max-w-3xl mx-auto">
                Remplissez le formulaire ci-dessous avec vos informations pour recevoir un devis personnalisé.
              </p>
              <QuoteForm />
            </TabsContent>
